...
void *dbap2d_new (Symbol *msg, short argc, Atom *argv);
void dbap2d_bang (dbap2d *x);
void dbap2d_assist(dbap2d *x, void *b, long m, long a, char *s);

void dbap2d_list (dbap2d *x, Symbol *msg, short argc, Atom *argv);	// set all snd's coords methoid
void dbap2d_speakers (dbap2d *x, Symbol *msg, short argc, Atom *argv);	// speakers coords
void dbap2d_setspeaker (dbap2d *x, Symbol *msg, short argc, Atom *argv);	// speakers coords
void dbap2d_radius(dbap2d *x, Symbol *msg, short argc, Atom *argv);
void dbap2d_snd_radius(dbap2d *x, Symbol *msg, short argc, Atom *argv);
void dbap2d_snd_diffusion(dbap2d *x, Symbol *msg, short argc, Atom *argv); //diffusion tris to work on 0.1. range
void dbap2d_diffusion(dbap2d *x, Symbol *msg, short argc, Atom *argv); 
void dbap2d_gain (dbap2d *x, Symbol *msg, short argc, Atom *argv);
void dbap2d_snd_gain(dbap2d *x, Symbol *msg, short argc, Atom *argv);
void dbap2d_db (dbap2d *x, Symbol *msg, short argc, Atom *argv);
void dbap2d_snd_db(dbap2d *x, Symbol *msg, short argc, Atom *argv);
...
void dbap2d_box_gain(dbap2d *x, Symbol *msg, short argc, Atom *argv); 


void dbap2d_num_sounds(dbap2d *x, int numsnds);
void dbap2d_om(dbap2d *x, Symbol *msg, short argc, Atom *argv);

void dbap2d_falloff_mode(dbap2d *x, int numsnds);
void dbap2d_falloff(dbap2d *x, Symbol *msg, short argc, Atom *argv);
void dbap2d_snd_falloff(dbap2d *x, Symbol *msg, short argc, Atom *argv);

void dbap2d_setsndc(dbap2d *x, Symbol *msg, short argc, Atom *argv);
//static inline dbap2d_calc_snd(dbap2d *x, int snd);
void dbap2d_calc_snd(dbap2d *x, int snd);
void dbap2d_box_scale (dbap2d *x);
void dbap2d_setboxcoords (dbap2d *x, Symbol *msg, short argc, Atom *argv);
void dbap2d_setboxcenter (dbap2d *x, Symbol *msg, short argc, Atom *argv);
void dbap2d_setboxdim (dbap2d *x, Symbol *msg, short argc, Atom *argv);
void dbap2d_setboxscale (dbap2d *x, Symbol *msg, short argc, Atom *argv);
void dbap2d_setboxmode (dbap2d *x, int x1);


void dbap2d_region (dbap2d *x, Symbol *msg, short argc, Atom *argv);	
void dbap2d_regions (dbap2d *x, Symbol *msg, short argc, Atom *argv);	
...
void dbap2d_version (dbap2d *x, Symbol *msg, short argc, Atom *argv);
void dbap2d_getspeakers (dbap2d *x, Symbol *msg, short argc, Atom *argv);
...
void main(void)
{
 ...
 setup((t_messlist**)&dbap2d_class,(method)dbap2d_new,0L,(short)sizeof(dbap2d),0L,
 A_GIMME,0);
 
// addbang((method)dbap2d_bang);
 addmess((method)dbap2d_list,					"list",				A_GIMME,0);
 addmess((method)dbap2d_speakers,				"speakers",			A_GIMME,0);
 addmess((method)dbap2d_getspeakers,			"getspeakers",		A_GIMME,0);
 addmess((method)dbap2d_setspeaker,				"speaker",			A_GIMME,0);
 addmess((method)dbap2d_num_sounds,				"num",				A_DEFLONG,0);
 addmess((method)dbap2d_radius,					"radius",			A_GIMME,0);
 addmess((method)dbap2d_snd_radius,				"radius_snd",			A_GIMME,0);
 addmess((method)dbap2d_snd_radius,				"radius_input",			A_GIMME,0);
 addmess((method)dbap2d_diffusion,				"diffusion",		A_GIMME,0);
 addmess((method)dbap2d_snd_diffusion,			"diffusion_snd",		A_GIMME,0);
 addmess((method)dbap2d_snd_diffusion,			"diffusion_input",		A_GIMME,0);
 addmess((method)dbap2d_gain,					"gain",				A_GIMME,0);
 addmess((method)dbap2d_snd_gain,				"gain_snd",				A_GIMME,0);
 addmess((method)dbap2d_snd_gain,				"gain_input",			A_GIMME,0);
 addmess((method)dbap2d_db,						"db",				A_GIMME,0);
 addmess((method)dbap2d_snd_db,					"db_snd",				A_GIMME,0);
 addmess((method)dbap2d_snd_db,					"db_input",				A_GIMME,0);
 addmess((method)dbap2d_setsndc,				"set",				A_GIMME,0);
 addmess((method)dbap2d_om,						"om",				A_GIMME,0);
 addmess((method)dbap2d_falloff_mode,			"falloff_mode",		A_LONG,0);
 addmess((method)dbap2d_falloff,				"falloff",			A_GIMME,0);
 addmess((method)dbap2d_snd_falloff,			"falloff_snd",			A_GIMME,0);
 addmess((method)dbap2d_snd_falloff,			"falloff_input",		A_GIMME,0);

 addmess((method)dbap2d_setboxcoords,			"boxcoords",		A_GIMME,0);
 addmess((method)dbap2d_setboxcenter,			"boxcenter",		A_GIMME,0);
 addmess((method)dbap2d_setboxdim,				"boxdim",			A_GIMME,0);
 addmess((method)dbap2d_setboxscale,			"boxscale",			A_GIMME,0);
 addmess((method)dbap2d_setboxmode,				"boxmode",			A_LONG,0);
 addmess((method)dbap2d_setbullseye,			"bullseye",			A_LONG,0);

 addmess((method)dbap2d_snd_active,				"active",			A_DEFLONG,A_DEFLONG,0);
 addmess((method)dbap2d_snd_active,				"active_snd",			A_DEFLONG,A_DEFLONG,0);
 addmess((method)dbap2d_snd_active,				"active_input",			A_DEFLONG,A_DEFLONG,0);
 addmess((method)dbap2d_speaker_active,			"active_speaker",			A_DEFLONG,A_DEFLONG,0);
 addmess((method)dbap2d_region_active,				"active_regions",			A_DEFLONG,A_DEFLONG,0);

 addmess((method)dbap2d_setregions,				"regions",			A_LONG,0);
 addmess((method)dbap2d_regions,				"regions_all",			A_GIMME,0);
 addmess((method)dbap2d_region,					"region",			A_GIMME,0);

 addmess((method)dbap2d_num_sounds,				"num_sounds",				A_DEFLONG,0);
 addmess((method)dbap2d_num_regions,			"num_regions",				A_DEFLONG,0);
 addmess((method)dbap2d_num_speakers,			"num_speakers",				A_DEFLONG,0);


	
 addmess((method)dbap2d_assist,					"assist", 			A_CANT, 0);
 addmess((method)dbap2d_version,				"version",				A_GIMME,0);

 post("a-dbap2d by andré sier, inspired by trond lossius © s373 2006-7 %08xd   "__DATE__" "__TIME__, tick, 0);
...
void *dbap2d_new (Symbol *msg, short argc, Atom *argv) //input the args 
{
	 dbap2d *x;
	 int i;
	 x=(dbap2d *)newobject(dbap2d_class);

	x->c_out2=outlet_new(x,0L);
	x->c_out=listout(x);
...
void dbap2d_diffusion(dbap2d *x, Symbol *msg, short argc, Atom *argv) //diffusion tris to work on 0.1. range
{
	if (argc) {
		double rad, maxdist;
		int i;
...
//	x->om=CLIP(numsnds,0,4);
	...
	for(i=0;i<num;i++) {
		...
		else if (argv[i].a_type == A_LONG) { temp[i] = (int) argv[i].a_w.w_long; }
		x->o[i].om = temp[i];
	}
...
void dbap2d_setboxcoords (dbap2d *x, Symbol *msg, short argc, Atom *argv)
{
	...
	for(i=0;i<4;i++) {
		...
		else if (argv[i].a_type == A_LONG) { temp[i] = (double) argv[i].a_w.w_long; }
...
void dbap2d_speakers (dbap2d *x, Symbol *msg, short argc, Atom *argv)
{
	int i;
...
void dbap2d_setspeaker (dbap2d *x, Symbol *msg, short argc, Atom *argv) // per speaker pos
{
	if (argc) {
...
void dbap2d_list (dbap2d *x, Symbol *msg, short argc, Atom *argv) //updated for <index> <pos> <optional active
{
...
void dbap2d_region (dbap2d *x, Symbol *msg, short argc, Atom *argv) // per speaker pos
{
	if (argc) {
		double	temp[DIMEN]={0.0f,0.0f};
		int i;
...
void dbap2d_assist(dbap2d *x, void *b, long m, long a, char *s)
{
    if (m==1) { sprintf(s,"list of coords, speakers"); }   
    else if (m==2&&a==0) { sprintf(s,"(list) to matrix~"); }
    else if (m==2&&a==1) { sprintf(s,"info"); }
}
