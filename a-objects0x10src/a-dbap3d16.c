...
void *dbap3d_new (Symbol *msg, short argc, Atom *argv);
void dbap3d_bang (dbap3d *x);
void dbap3d_assist(dbap3d *x, void *b, long m, long a, char *s);

void dbap3d_list (dbap3d *x, Symbol *msg, short argc, Atom *argv);	// set all snd's coords methoid
void dbap3d_speakers (dbap3d *x, Symbol *msg, short argc, Atom *argv);	// speakers coords
void dbap3d_setspeaker (dbap3d *x, Symbol *msg, short argc, Atom *argv);	// speakers coords
void dbap3d_radius(dbap3d *x, Symbol *msg, short argc, Atom *argv);
void dbap3d_snd_radius(dbap3d *x, Symbol *msg, short argc, Atom *argv);
void dbap3d_snd_diffusion(dbap3d *x, Symbol *msg, short argc, Atom *argv); //diffusion tris to work on 0.1. range
void dbap3d_diffusion(dbap3d *x, Symbol *msg, short argc, Atom *argv); 
void dbap3d_gain (dbap3d *x, Symbol *msg, short argc, Atom *argv);
void dbap3d_snd_gain(dbap3d *x, Symbol *msg, short argc, Atom *argv);
void dbap3d_db (dbap3d *x, Symbol *msg, short argc, Atom *argv);
void dbap3d_snd_db(dbap3d *x, Symbol *msg, short argc, Atom *argv);
...
void dbap3d_box_gain(dbap3d *x, Symbol *msg, short argc, Atom *argv); 


void dbap3d_num_sounds(dbap3d *x, int numsnds);
void dbap3d_om(dbap3d *x, Symbol *msg, short argc, Atom *argv);

void dbap3d_falloff_mode(dbap3d *x, int numsnds);
void dbap3d_falloff(dbap3d *x, Symbol *msg, short argc, Atom *argv);
void dbap3d_snd_falloff(dbap3d *x, Symbol *msg, short argc, Atom *argv);

void dbap3d_setsndc(dbap3d *x, Symbol *msg, short argc, Atom *argv);
//static inline dbap3d_calc_snd(dbap3d *x, int snd);
void dbap3d_calc_snd(dbap3d *x, int snd);
void dbap3d_box_scale (dbap3d *x);
void dbap3d_setboxcoords (dbap3d *x, Symbol *msg, short argc, Atom *argv);
void dbap3d_setboxcenter (dbap3d *x, Symbol *msg, short argc, Atom *argv);
void dbap3d_setboxdim (dbap3d *x, Symbol *msg, short argc, Atom *argv);
void dbap3d_setboxscale (dbap3d *x, Symbol *msg, short argc, Atom *argv);
void dbap3d_setboxmode (dbap3d *x, int x1);


void dbap3d_region (dbap3d *x, Symbol *msg, short argc, Atom *argv);	
void dbap3d_regions (dbap3d *x, Symbol *msg, short argc, Atom *argv);	
...
void dbap3d_version (dbap3d *x, Symbol *msg, short argc, Atom *argv);
void dbap3d_getspeakers (dbap3d *x, Symbol *msg, short argc, Atom *argv);
...
// addbang((method)dbap3d_bang);
 addmess((method)dbap3d_list,					"list",				A_GIMME,0);
 addmess((method)dbap3d_speakers,				"speakers",			A_GIMME,0);
 addmess((method)dbap3d_getspeakers,			"getspeakers",		A_GIMME,0);
 addmess((method)dbap3d_setspeaker,				"speaker",			A_GIMME,0);
 addmess((method)dbap3d_num_sounds,				"num",				A_DEFLONG,0);
 addmess((method)dbap3d_radius,					"radius",			A_GIMME,0);
 addmess((method)dbap3d_snd_radius,				"radius_snd",			A_GIMME,0);
 addmess((method)dbap3d_snd_radius,				"radius_input",			A_GIMME,0);
 addmess((method)dbap3d_diffusion,				"diffusion",		A_GIMME,0);
 addmess((method)dbap3d_snd_diffusion,			"diffusion_snd",		A_GIMME,0);
 addmess((method)dbap3d_snd_diffusion,			"diffusion_input",		A_GIMME,0);
 addmess((method)dbap3d_gain,					"gain",				A_GIMME,0);
 addmess((method)dbap3d_snd_gain,				"gain_snd",				A_GIMME,0);
 addmess((method)dbap3d_snd_gain,				"gain_input",			A_GIMME,0);
 addmess((method)dbap3d_db,						"db",				A_GIMME,0);
 addmess((method)dbap3d_snd_db,					"db_snd",				A_GIMME,0);
 addmess((method)dbap3d_snd_db,					"db_input",				A_GIMME,0);
 addmess((method)dbap3d_setsndc,				"set",				A_GIMME,0);
 addmess((method)dbap3d_om,						"om",				A_GIMME,0);
 addmess((method)dbap3d_falloff_mode,			"falloff_mode",		A_LONG,0);
 addmess((method)dbap3d_falloff,				"falloff",			A_GIMME,0);
 addmess((method)dbap3d_snd_falloff,			"falloff_snd",			A_GIMME,0);
 addmess((method)dbap3d_snd_falloff,			"falloff_input",		A_GIMME,0);

 addmess((method)dbap3d_setboxcoords,			"boxcoords",		A_GIMME,0);
 addmess((method)dbap3d_setboxcenter,			"boxcenter",		A_GIMME,0);
 addmess((method)dbap3d_setboxdim,				"boxdim",			A_GIMME,0);
 addmess((method)dbap3d_setboxscale,			"boxscale",			A_GIMME,0);
 addmess((method)dbap3d_setboxmode,				"boxmode",			A_LONG,0);
 addmess((method)dbap3d_setbullseye,			"bullseye",			A_LONG,0);

 addmess((method)dbap3d_snd_active,				"active",			A_DEFLONG,A_DEFLONG,0);
 addmess((method)dbap3d_snd_active,				"active_snd",			A_DEFLONG,A_DEFLONG,0);
 addmess((method)dbap3d_snd_active,				"active_input",			A_DEFLONG,A_DEFLONG,0);
 addmess((method)dbap3d_speaker_active,			"active_speaker",			A_DEFLONG,A_DEFLONG,0);
 addmess((method)dbap3d_region_active,				"active_regions",			A_DEFLONG,A_DEFLONG,0);

 addmess((method)dbap3d_setregions,				"regions",			A_LONG,0);
 addmess((method)dbap3d_regions,				"regions_all",			A_GIMME,0);
 addmess((method)dbap3d_region,					"region",			A_GIMME,0);

 addmess((method)dbap3d_num_sounds,				"num_sounds",				A_DEFLONG,0);
 addmess((method)dbap3d_num_regions,			"num_regions",				A_DEFLONG,0);
 addmess((method)dbap3d_num_speakers,			"num_speakers",				A_DEFLONG,0);


	
 addmess((method)dbap3d_assist,					"assist", 			A_CANT, 0);
 addmess((method)dbap3d_version,				"version",				A_GIMME,0);

 post("a-dbap3d by andrŽ sier, inspired by trond lossius © s373 2006-7 %08xd   "__DATE__" "__TIME__, tick, 0);
...
void *dbap3d_new (Symbol *msg, short argc, Atom *argv) //input the args 
{
	 dbap3d *x;
	 int i,j;
	 x=(dbap3d *)newobject(dbap3d_class);
...
void dbap3d_diffusion(dbap3d *x, Symbol *msg, short argc, Atom *argv) //diffusion tris to work on 0.1. range
{
	if (argc) {
		double rad, maxdist;
		int i;
...
void dbap3d_speakers (dbap3d *x, Symbol *msg, short argc, Atom *argv)
{
	int i;
...
void dbap3d_setspeaker (dbap3d *x, Symbol *msg, short argc, Atom *argv) // per speaker pos
{
	if (argc) {
...
void dbap3d_list (dbap3d *x, Symbol *msg, short argc, Atom *argv) //updated for <index> <pos> <optional active
{
...
void dbap3d_region (dbap3d *x, Symbol *msg, short argc, Atom *argv) // per speaker pos
{
	if (argc) {
		double	temp[DIMEN]={0.0f,0.0f,0.0f};
		int i;
